...
int __cdecl main(int argc, char* argv[])
{
    ...
    *_tcsrchr(exePath, _T('\\')) = _T('\0');
    PTCHAR infPath = _T("MyDeskIddDriver\\MyDeskIddDriver.inf");
    ...
    do
    {
        ...
        case 'u':
            ...
            //if (FALSE == InstallUpdate(_T("D:\\projects\\windows\\IndirectDisplay\\x64\\Debug\\MyDeskIddDriver\\MyDeskIddDriver.inf"), &rebootRequired))
            {
                printf(GetLastMsg());
            }
            else
