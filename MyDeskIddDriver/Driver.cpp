...
//
// Define an Interface Guid for MyDeskIddDriver device class.
// This GUID is used to register (IoRegisterDeviceInterface)
// an instance of an interface so that user application
// can control the MyDeskIddDriver device.
//
...
EVT_WDF_DRIVER_UNLOAD MyDeskIddDriverUnload;
EVT_WDF_DRIVER_DEVICE_ADD IddMyDeskDeviceAdd;
EVT_WDF_DEVICE_D0_ENTRY IddMyDeskDeviceD0Entry;

// https://docs.microsoft.com/en-us/windows-hardware/drivers/kernel/defining-i-o-control-codes
EVT_IDD_CX_DEVICE_IO_CONTROL IddMyDeskIoDeviceControl;

EVT_IDD_CX_ADAPTER_INIT_FINISHED IddMyDeskAdapterInitFinished;
EVT_IDD_CX_ADAPTER_COMMIT_MODES IddMyDeskAdapterCommitModes;

EVT_IDD_CX_PARSE_MONITOR_DESCRIPTION IddMyDeskParseMonitorDescription;
EVT_IDD_CX_MONITOR_GET_DEFAULT_DESCRIPTION_MODES IddMyDeskMonitorGetDefaultModes;
EVT_IDD_CX_MONITOR_QUERY_TARGET_MODES IddMyDeskMonitorQueryModes;

EVT_IDD_CX_MONITOR_ASSIGN_SWAPCHAIN IddMyDeskMonitorAssignSwapChain;
EVT_IDD_CX_MONITOR_UNASSIGN_SWAPCHAIN IddMyDeskMonitorUnassignSwapChain;
...
)
{
    ...
    Config.EvtDriverUnload = MyDeskIddDriverUnload;
...
_Use_decl_annotations_
void MyDeskIddDriverUnload(_In_ WDFDRIVER /*Driver*/)
{
    WPP_CLEANUP(WdfDriverWdmGetDriverObject(Driver));
}
...
_Use_decl_annotations_
NTSTATUS IddMyDeskDeviceAdd(WDFDRIVER Driver, PWDFDEVICE_INIT pDeviceInit)
{
    ...
    PnpPowerCallbacks.EvtDeviceD0Entry = IddMyDeskDeviceD0Entry;
    ...
    IddConfig.EvtIddCxDeviceIoControl = IddMyDeskIoDeviceControl;

    IddConfig.EvtIddCxAdapterInitFinished = IddMyDeskAdapterInitFinished;

    IddConfig.EvtIddCxParseMonitorDescription = IddMyDeskParseMonitorDescription;
    IddConfig.EvtIddCxMonitorGetDefaultDescriptionModes = IddMyDeskMonitorGetDefaultModes;
    IddConfig.EvtIddCxMonitorQueryTargetModes = IddMyDeskMonitorQueryModes;
    IddConfig.EvtIddCxAdapterCommitModes = IddMyDeskAdapterCommitModes;
    IddConfig.EvtIddCxMonitorAssignSwapChain = IddMyDeskMonitorAssignSwapChain;
    IddConfig.EvtIddCxMonitorUnassignSwapChain = IddMyDeskMonitorUnassignSwapChain;
...
_Use_decl_annotations_
NTSTATUS IddMyDeskDeviceD0Entry(WDFDEVICE Device, WDF_POWER_DEVICE_STATE PreviousState)
{
...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"MyDesk Idd Device";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"MyDesk";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"MyDesk Idd Model";
...
_Use_decl_annotations_
VOID
IddMyDeskIoDeviceControl(WDFDEVICE Device, WDFREQUEST Request, size_t OutputBufferLength, size_t InputBufferLength, ULONG IoControlCode)
{
    TraceEvents(TRACE_LEVEL_INFORMATION,
        TRACE_DEVICE,
...
_Use_decl_annotations_
NTSTATUS IddMyDeskAdapterInitFinished(IDDCX_ADAPTER AdapterObject, const IDARG_IN_ADAPTER_INIT_FINISHED* pInArgs)
{
...
_Use_decl_annotations_
NTSTATUS IddMyDeskAdapterCommitModes(IDDCX_ADAPTER AdapterObject, const IDARG_IN_COMMITMODES* pInArgs)
{
    TraceEvents(TRACE_LEVEL_VERBOSE, TRACE_DEVICE, "%!FUNC! called");
...
_Use_decl_annotations_
NTSTATUS IddMyDeskParseMonitorDescription(const IDARG_IN_PARSEMONITORDESCRIPTION* pInArgs, IDARG_OUT_PARSEMONITORDESCRIPTION* pOutArgs)
{
    TraceEvents(TRACE_LEVEL_VERBOSE, TRACE_DEVICE, "%!FUNC! called");
...
_Use_decl_annotations_
NTSTATUS IddMyDeskMonitorGetDefaultModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_GETDEFAULTDESCRIPTIONMODES* pInArgs, IDARG_OUT_GETDEFAULTDESCRIPTIONMODES* pOutArgs)
{
    TraceEvents(TRACE_LEVEL_VERBOSE, TRACE_DEVICE, "%!FUNC! called");
...
_Use_decl_annotations_
NTSTATUS IddMyDeskMonitorQueryModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_QUERYTARGETMODES* pInArgs, IDARG_OUT_QUERYTARGETMODES* pOutArgs)
{
    TraceEvents(TRACE_LEVEL_VERBOSE, TRACE_DEVICE, "%!FUNC! called");
...
_Use_decl_annotations_
NTSTATUS IddMyDeskMonitorAssignSwapChain(IDDCX_MONITOR MonitorObject, const IDARG_IN_SETSWAPCHAIN* pInArgs)
{
...
_Use_decl_annotations_
NTSTATUS IddMyDeskMonitorUnassignSwapChain(IDDCX_MONITOR MonitorObject)
{
    TraceEvents(TRACE_LEVEL_VERBOSE, TRACE_DEVICE, "%!FUNC! called");
